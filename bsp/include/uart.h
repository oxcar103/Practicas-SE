 ...
 * @return      El número de bytes almacenados en el búfer de transmisión en caso de éxito o -1 en caso de error.
 *              La condición de error se indica en la variable global errno
 */
 ...
 * @return      El número de bytes realmente leídos en caso de éxito o -1 en caso de error.
 *              La condición de error se indica en la variable global errno
 */
